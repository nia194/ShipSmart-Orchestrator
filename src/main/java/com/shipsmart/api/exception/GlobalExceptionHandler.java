...
/**
 * RFC 7807 ProblemDetail responses for every error path. Extension members: requestId, traceId,
 * timestamp, errors[].
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleOwnership(
            OwnershipException ex, HttpServletRequest req) {
        return problem(
    ...
    public ResponseEntity<ProblemDetail> handleAccessDenied(
        ...
        return problem(
                HttpStatus.FORBIDDEN, "access-denied", "Access denied", ex.getMessage(), req);
    }
    ...
    public ResponseEntity<ProblemDetail> handleIdempotency(
    ...
    public ResponseEntity<ProblemDetail> handleRateLimit(
        ...
        ResponseEntity<ProblemDetail> resp =
                problem(
                        ...
                        "rate-limit",
                        "Rate limit exceeded",
                        "Try again in " + ex.getRetryAfterSeconds() + "s",
                        req);
    ...
    private ResponseEntity<ProblemDetail> problem(
            HttpStatus status, String slug, String title, String detail, HttpServletRequest req) {
