...
/**
 * Abstraction for shipping carrier providers. Implementations fetch real quotes from carrier APIs.
...
public interface ShippingProvider {
    ...
    /**
     * Get shipping quotes for the given shipment. Returns an empty list if the route is not
     * supported or if an error occurs.
     *
