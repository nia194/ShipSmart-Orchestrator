...
/**
 * Wraps write-verb requests so the body can be re-read by idempotency hashing, and wraps the
 * response so {@link IdempotencyInterceptor} can persist the captured body after the handler
 * completes.
 */
@Component
