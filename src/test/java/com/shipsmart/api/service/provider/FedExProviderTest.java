...
class FedExProviderTest {
    ...
    void getQuotes_returnsEmptyListWhenNotConfigured() {
        ...
        FedExProvider unconfigured =
                new FedExProvider(restTemplate, "https://apis-sandbox.fedex.com", "", "", "");
    ...
    void getQuotes_parsesValidFedExResponse() {
        ...
        Map<String, Object> tokenResponse =
                Map.of("access_token", "test-token-12345", "expires_in", 3600);

        // Mock FedEx rate response
        @SuppressWarnings("unchecked")
        Map<String, Object> rateResponse =
                Map.of(
                        "output",
                        Map.of(
                                "rateReplyDetails",
                                List.of(
                                        Map.of(
                                                ...
                                                "ratedShipmentDetails",
                                                        List.of(Map.of("totalNetCharge", "45.50")),
                                                "commit",
                                                        Map.of(
                                                                "transitDays",
                                                                Map.of("description", "5"))),
                                        Map.of(
                                                "serviceType", "FEDEX_EXPRESS_SAVER",
                                                "ratedShipmentDetails",
                                                        List.of(Map.of("totalNetCharge", "95.00")),
                                                "commit",
                                                        Map.of(
                                                                "transitDays",
                                                                Map.of("description", "3"))))));

        when(restTemplate.postForObject(contains("/oauth/token"), any(), eq(Map.class)))
                .thenReturn(tokenResponse);

        when(restTemplate.postForObject(contains("/rate/v1/rates/quotes"), any(), eq(Map.class)))
    ...
    void getQuotes_returnsEmptyListForEmptyRateResponse() {
        ...
        Map<String, Object> emptyResponse = Map.of("output", Map.of("rateReplyDetails", List.of()));
