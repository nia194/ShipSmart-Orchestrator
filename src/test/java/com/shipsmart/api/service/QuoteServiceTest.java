...
class QuoteServiceTest {
    ...
    @Mock private FedExProvider fedExProvider;
    ...
    void generateQuotes_returnsCorrectStructure() {
        ...
        assertEquals(
                1, response.privateSection().more().size(), "Private should have 1 more option");
    }
    ...
    void generateQuotes_correctCarrierIds() {
        QuoteRequest request =
                new QuoteRequest(
                        ...
                        List.of(
                                new PackageItemDto(
                                        "luggage", "1", "30", "24", "15", "10", "standard")));
    ...
    void generateQuotes_multiplePackagesAggregateWeight() {
        ...
        QuoteRequest request =
                new QuoteRequest(
                        ...
                        List.of(
                                new PackageItemDto(
                                        "luggage", "2", "20", "24", "15", "10", "standard"),
                                new PackageItemDto(
                                        "boxes", "1", "10", "20", "15", "12", "standard")));
    ...
    void generateQuotes_integratesRealFedExQuotes() {
        ...
        ShippingServiceDto realFedExGround =
        ...
        ShippingServiceDto realFedExExpress =
                new ShippingServiceDto(
                        "fedex-express",
                        "FedEx",
                        "FedEx Express Saver",
        ...
        when(fedExProvider.getQuotes(any())).thenReturn(List.of(realFedExGround, realFedExExpress));
    ...
    void generateQuotes_fallsBackToMockWhenFedExUnavailable() {
        ...
        assertEquals(
                3,
                response.prime().top().size(),
                "Prime top should have 3 quotes (UPS, FedEx mock, DHL)");
        assertEquals(
                2, response.prime().more().size(), "Prime more should have 2 mock FedEx quotes");
